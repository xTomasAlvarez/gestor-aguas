...
## 🚀 1. Bienvenida y Configuración Inicial (Para Dueños)
Cuando ingresas por primera vez con tu cuenta de Administrador, el sistema te pedirá configurar tu empresa mediante un "Wizard" de 3 pasos simples:
1. **Tu Negocio:** Escribe el nombre de tu empresa de reparto.
2. **Tu Catálogo:** Selecciona qué productos vendes (Ej: Bidón 12L, Bidón 20L).
3. **Tus Precios:** Asigna el precio de venta al público para cada producto.

*¡Listo! Con eso, la app adopta el nombre de tu negocio en la barra superior y tus repartidores ya pueden salir a vender con los precios actualizados.*

---

## 🚚 2. La Operación en la Calle (Para Repartidores)
La app está diseñada para usarse desde el celular con una mano rápida.

### Cómo registrar una venta rápidamente:
...
## 📊 3. Entendiendo las Estadísticas (Para Dueños)
Con un solo vistazo a la sección **"Stats"** del menú, verás la salud de tu negocio en tiempo real. Tienes 3 filtros arriba: `Hoy`, `Semana`, `Mes`.
...
## 🤝 5. Sumando Repartidores (Para Dueños)
Vos como administrador no debés compartir ni tu correo ni tu contraseña con tus empleados. Ellos tienen su propio usuario limitado.
